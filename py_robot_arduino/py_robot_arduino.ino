...
enum
{
  ...
  kDriveRobot          , // Switch to dirve straight
  kRobotStatus         , // Messages on the Robot's status
};
...
void attachCommandCallbacks()
{
  ...
  cmdMessenger.attach(kDriveRobot, OnDriveRobot);
}
...
void OnDriveRobot()
{
  cmdMessenger.sendCmd(kRobotStatus,"Robot is ready");
}
